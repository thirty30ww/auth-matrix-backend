...
1. **环境准备** - [快速开始](document/1.快速开始.md)
2. **环境配置** - [环境配置指南](document/2.环境配置指南.md)
3. **数据库部署** - [数据库部署指南](document/3.数据库部署指南.md)
4. **依赖安装** - [依赖安装指南](document/4.依赖安装指南.md)
